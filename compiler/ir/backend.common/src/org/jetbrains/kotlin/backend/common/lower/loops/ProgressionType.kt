...
internal class IntProgressionType(symbols: Symbols<CommonBackendContext>) :
    ProgressionType(
        ...
        getProgressionLastElementFunction = symbols.getProgressionLastElementByReturnType[symbols.int.defaultType.toKotlinType()]
    ) {
...
internal class LongProgressionType(symbols: Symbols<CommonBackendContext>) :
    ProgressionType(
        ...
        getProgressionLastElementFunction = symbols.getProgressionLastElementByReturnType[symbols.long.defaultType.toKotlinType()]
    ) {
...
internal class UIntProgressionType(symbols: Symbols<CommonBackendContext>) :
    UnsignedProgressionType(
        ...
        getProgressionLastElementFunction = symbols.getProgressionLastElementByReturnType[symbols.uInt!!.defaultType.toKotlinType()],
...
internal class ULongProgressionType(symbols: Symbols<CommonBackendContext>) :
    UnsignedProgressionType(
        ...
        getProgressionLastElementFunction = symbols.getProgressionLastElementByReturnType[symbols.uLong!!.defaultType.toKotlinType()],
